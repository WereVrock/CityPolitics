...
public class Pop {
    ...
    private final City.main.pops.PopElectoralData electoralData;
    ...
    public Pop(PopType type, PolitcalView affiliation) {
        ...
        this.electoralData = new City.main.pops.PopElectoralData(new java.util.Random());
    }
    ...
    public City.main.pops.PopElectoralData getElectoralData() { return electoralData; }
