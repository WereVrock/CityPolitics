...
public final class DiplomacyParams {

    // claim
    public static final double CLAIM_BASE_SUCCESS_CHANCE = 0.4;
    public static final double DEMAND_WEALTH_FRACTION = 0.2;
    // superiority
    ...
    public static final double RAID_PRODUCTION_MALUS = 0.3;
    public static final double COALITION_ARMY_THRESHOLD = 0.9;
    public static final double RAID_GOLD_ZONE_MULTIPLIER = 3.0;
    public static final double DEMAND_ALLIED_BONUS = 30.0;
    public static final double ALLIANCE_BREAK_CLEAN_BASE = 0.3;
    public static final double CLAIM_DECAY_CHANCE = 0.3;
    public static final double RAID_INTERCEPT_BASE_CHANCE = 0.2;
    public static final double GIFT_WEIGHT_PRESTIGE = 0.3;
    public static final double DEMAND_ACCEPT_THRESHOLD = 50.0;
    public static final double DEMAND_RANDOM_RANGE = 15.0;
    public static final double CLAIM_ADJACENCY_PENALTY = 0.5;
    public static final double RAID_INTERCEPT_MILITARY_BONUS = 0.05;
    public static final double DEMAND_PRESTIGE_WEIGHT = 0.3;
    public static final double ALLY_BASE_ACCEPT_CHANCE = 0.5;
    ...
    // military skill
    public static final double MILITARY_SKILL_BONUS_PER_POINT = 0.1;
    public static final double GIFT_WEIGHT_EXPANSION = 0.1;
    // alliance
    ...
    public static final double ALLY_DIPLOMACY_BONUS_PER_POINT = 0.1;
    public static final double GIFT_WEIGHT_WEALTH = 0.25;
    public static final double ALLIANCE_MIN_ARMY_FRACTION = 0.5;
