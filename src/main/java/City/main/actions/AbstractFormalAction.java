...
import City.main.politics.VotingEngine;
...
public final ActionResult execute(ResourcePool resources, StatBlock stats) {
    ...
    getLedger().applyOneTime(City.main.resources.ResourceType.INFLUENCE, "action", getName(),
    ...
    recordUse();
    City.debug.Debug.log("formal-action", "execute", getName()
