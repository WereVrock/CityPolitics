...
public class DealOffer {
    ...
    public boolean canAfford(City.main.resources.ResourcePool res, City.main.resources.StatBlock stats) {
        if (favourOnly) {
...
public void apply(City.main.resources.ResourcePool res, City.main.resources.StatBlock stats) {
    if (!favourOnly) {
...
public void apply(City.main.resources.ResourcePool res, City.main.resources.StatBlock stats,
                  City.main.politics.PoliticalParty party,
