...
public void refresh() {
    ...
    boolean isFormal = action instanceof City.main.actions.AbstractFormalAction;
    if (isFormal) {
    ...
    boolean isLegGated = action instanceof City.main.actions.WartimeTaxesAction
            || action instanceof City.main.actions.HireMercenariesAction
            || action instanceof City.main.actions.SendResourcesToNoblesAction
            || action instanceof City.main.actions.GrantZoneClaimAction;
    ...
    if (!available) {
        String reason = null;
        if (action instanceof City.main.actions.WartimeTaxesAction wta) {
            reason = wta.getUnavailableReason();
        } else if (action instanceof City.main.actions.HireMercenariesAction) {
            reason = "Mercenary hiring not currently authorised.";
        } else if (action instanceof City.main.actions.AbstractFormalAction) {
