...
public class LegislationManager {
    ...
    public void markPassed(LegislationType type) {
        ...
        debug.Debug.log("legislation", "passed", type.name());
    }
    ...
    public void grantSendResourcesWindow() {
        sendResourcesWindowRemaining = main.parameters.GameParameters.SEND_RESOURCES_WINDOW_TURNS;
        debug.Debug.log("legislation", "send-resources-window",
    ...
    public void grantMercenaryHireWindow() {
        ...
        debug.Debug.log("legislation", "merc-window", "Mercenary hire window granted (3 turns)");
    }
    ...
    public void tickMercenaryWindow() {
        if (mercenaryHireActionsRemaining > 0) {
            ...
            debug.Debug.log("legislation", "merc-window",
    ...
    public void triggerWartimeTaxesCooldown() {
        wartimeTaxesCooldown = main.parameters.GameParameters.WARTIME_TAXES_COOLDOWN_TURNS;
        debug.Debug.log("legislation", "wartime-tax", "Cooldown set to " + wartimeTaxesCooldown);
    }
