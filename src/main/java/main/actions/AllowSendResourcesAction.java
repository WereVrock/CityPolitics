...
public class AllowSendResourcesAction extends AbstractFormalAction {
    ...
    public String getDescription() {
        return "Vote to allow sending resources to noble houses for "
                + main.parameters.GameParameters.SEND_RESOURCES_WINDOW_TURNS + " turns. "
                + "Costs " + main.parameters.GameParameters.ALLOW_SEND_RESOURCES_INFLUENCE_COST
                + " influence.";
    }

    @Override
    public int getInfluenceCost() {
        return main.parameters.GameParameters.ALLOW_SEND_RESOURCES_INFLUENCE_COST;
    }
