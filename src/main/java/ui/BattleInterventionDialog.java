...
import main.army.PlayerBattleInterventionProcessor.PlayerChoice;
...
public class BattleInterventionDialog {
    ...
    public static PlayerChoice show(Window parent,
        ...
        JLabel info = new JLabel("<html>"
                + "<b>" + ui.GrantZoneClaimDialog.stripHousePrefix(attackerName) + "</b>"
                + " is attacking <b>"
                + ui.GrantZoneClaimDialog.stripHousePrefix(defenderName) + "</b>"
        ...
        JButton joinAtkBtn  = makeBtn("Join " + ui.GrantZoneClaimDialog.stripHousePrefix(attackerName),
                new Color(200, 80, 60));
        JButton joinDefBtn  = makeBtn("Join " + ui.GrantZoneClaimDialog.stripHousePrefix(defenderName),
